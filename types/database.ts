...
export interface Database {
  public: {
    Tables: {
      ...
      notifications: { Row: { id: string; group_id: string; event_id: string; user_id: string; type: 'event_published' | 'event_updated' | 'poll_opened' | 'turn_assigned'; is_read: boolean; created_at: string; }; Insert: { id?: string; group_id: string; event_id: string; user_id: string; type: 'event_published' | 'event_updated' | 'poll_opened' | 'turn_assigned'; is_read?: boolean; created_at?: string; }; Update: { id?: string; group_id?: string; event_id?: string; user_id?: string; type?: 'event_published' | 'event_updated' | 'poll_opened' | 'turn_assigned'; is_read?: boolean; created_at?: string; }; Relationships: []; };
